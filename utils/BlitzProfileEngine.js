...
const PROFILES = [
    ...
    },
    {
        ...
        condition: (s) => s.typedString.toUpperCase().includes('WHY') && !s.typedString.toUpperCase().includes('WTF')
    },
...
class BlitzProfileEngine extends BaseProfileEngine {
    static analyze(keyHistory) {
        return super.analyze(keyHistory, PROFILES, 40, 2);
    }
