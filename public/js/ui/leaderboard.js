...
export function renderLeaderboard(data, append = false, currentSession = null) {
    ...
    data.forEach((player, index) => {
        ...
        let titleMedalHtml = '';
        if (displayProfiles.length >= totalLegitProfiles) titleMedalHtml = `<img src="/assets/icons/medals/completionist.png" alt="Completionist Trophy" class="h-10 w-10 ml-2 drop-shadow-[0_0_15px_rgba(250,204,21,0.6)] cursor-help transition-transform hover:scale-110 -my-1" title="Completionist (${displayProfiles.length}/${totalLegitProfiles} Profiles)" /><span class="hidden md:inline-block ml-1 text-[9px] font-black text-yellow-400 uppercase tracking-widest mt-1">Completionist</span>`;
        else if (displayProfiles.length >= 110) titleMedalHtml = `<img src="/assets/icons/medals/gold.png" alt="Gold Medal" class="h-8 w-8 ml-2 drop-shadow-[0_0_10px_rgba(250,204,21,0.5)] cursor-help transition-transform hover:scale-110 -my-1" title="Legendary Collector (${displayProfiles.length}+ Profiles)" /><span class="hidden md:inline-block ml-1 text-[9px] font-black text-yellow-500 uppercase tracking-widest mt-0.5">Legendary</span>`;
        else if (displayProfiles.length >= 70) titleMedalHtml = `<img src="/assets/icons/medals/silver.png" alt="Silver Medal" class="h-7 w-7 ml-2 drop-shadow-md cursor-help transition-transform hover:scale-110 -my-0.5" title="Master Collector (${displayProfiles.length}+ Profiles)" /><span class="hidden md:inline-block ml-1 text-[9px] font-black text-slate-300 uppercase tracking-widest mt-0.5">Master</span>`;
        else if (displayProfiles.length >= 25) titleMedalHtml = `<img src="/assets/icons/medals/bronze.png" alt="Bronze Medal" class="h-7 w-7 ml-2 drop-shadow-md cursor-help transition-transform hover:scale-110 -my-0.5" title="Novice Collector (${displayProfiles.length}+ Profiles)" /><span class="hidden md:inline-block ml-1 text-[9px] font-black text-amber-600 uppercase tracking-widest mt-0.5">Novice</span>`;
        else titleMedalHtml = `<img src="/assets/icons/medals/noob.png" alt="Noob Medal" class="h-7 w-7 ml-2 drop-shadow-md cursor-help transition-transform hover:scale-110 filter grayscale opacity-70 -my-0.5" title="Noob Collector (<25 Profiles)" /><span class="hidden md:inline-block ml-1 text-[9px] font-black text-slate-500 uppercase tracking-widest mt-0.5">Noob</span>`;
